...
require (
	cloud.google.com/go/storage v1.59.0 // @grafana/grafana-backend-group
	...
	github.com/docker/docker v28.5.2+incompatible // @grafana/grafana-developer-enablement-squad
	...
	github.com/googleapis/gax-go/v2 v2.18.0 // indirect; @grafana/grafana-backend-group
	...
	go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc v0.63.0 // indirect; @grafana/plugins-platform-backend
	...
	golang.org/x/time v0.15.0 // indirect; @grafana/grafana-backend-group
...
require (
	...
	google.golang.org/genproto v0.0.0-20260217215200-42d3e9bedb6d // indirect; @grafana/grafana-backend-group
